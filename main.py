...
Classes info: https://python.plainenglish.io/learn-classes-by-making-a-game-in-python-5aedee38fc18
'''
...
class Setup():
    ...
    def scoreboard(self):
        ...
        text = font.render(f"SCOREBOARD: {self.score}", True, self.green, self.blue)
    ...
    def game_over_text(self):
        ...
        text = font.render(f"GAME OVER. FINAL SCORE: {self.score}", True, self.red, self.blue)
    ...
    def play_again_text(self):
        font = pygame.font.Font('freesansbold.ttf', 32)
        text = font.render("Press spacebar to play again", True, self.green)
...
class Player:
    ...
    def player(self, x_position, y_position):
        screen.blit(self.player_img, (x_position, y_position)) # blit() is a method that draws something onto the screen - we want to draw our player spaceship on it. Arguments: blit(image, (x coordinates, y coordinates))
        ...
        if self.player_x > 736: #less than 800 to account for the spaceship size (64px)
            self.player_x = 736
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN: 
            ...
            if event.key == pygame.K_LEFT:
                ...
                player.player_x_change -= player_and_bullet_x_speed
                bullet.bullet_x_change -= player_and_bullet_x_speed
