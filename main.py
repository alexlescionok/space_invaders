...
class Setup():
    ...
    def scoreboard(self):
        ...
        text = font.render(f"SCOREBOARD: {score}", True, self.green, self.blue)
    ...
    def game_over_text(self):
        ...
        text = font.render(f"GAME OVER. FINAL SCORE: {score}", True, self.red, self.blue)
        # use get_rect and center to position text in the middle
        position = text.get_rect(center=(self.x_window / 2, self.y_window / 2))
        screen = pygame.display.set_mode((self.x_window, self.y_window))
    ...
    def play_again_text(self):
        ...
        position = text.get_rect(center=(self.x_window / 2, self.y_window / 2 + 100))
        screen = pygame.display.set_mode((self.x_window, self.y_window))
        screen.blit(text, position)
